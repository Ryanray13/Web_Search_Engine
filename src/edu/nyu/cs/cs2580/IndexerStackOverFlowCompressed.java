...
public class IndexerStackOverFlowCompressed extends IndexerInvertedCompressed implements
  ...
  private void processDocument(File file, String pathPrefix)
    ...
    try {
      ...
      if (e != null) {
        ...
        docTermWriter.writeInt(answerTermList.size());
        for(String str : answerTermList){
          docTermWriter.writeUTF(str);
        }
        docTermWriter.flush();
   ...
   */
  public List<String> getAnswers(int docid){
    int offset = 0;
    if (docid != 0) {
